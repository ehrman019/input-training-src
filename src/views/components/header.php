    ...
    <header>
        <div class="header-content">
            <div class="header-title">
                <a href="./index.php">
                    <p class="header-app-logo app-logo">INPUT-TR</p>
                </a>
                <p class="header-title-main">アンケート集計トレーニング</p>
            </div>

            <!-- <img src="img/jobtr_logo_basic_white.png" alt="Jobtra-logo"> -->
        </div>
    </header>
